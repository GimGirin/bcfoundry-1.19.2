package gim.bcfoundry.item.custom.weapons.keyblade.terra_keys;
...
public class EndsOfTheEarthKeybladeItem extends SwordItem {
    public EndsOfTheEarthKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Upgraded version of Terra's original keyblade").formatted(Formatting.GRAY));
