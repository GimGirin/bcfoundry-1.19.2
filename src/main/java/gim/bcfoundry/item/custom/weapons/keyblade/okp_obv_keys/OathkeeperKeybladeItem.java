package gim.bcfoundry.item.custom.weapons.keyblade.okp_obv_keys;
...
public class OathkeeperKeybladeItem extends SwordItem {
    public OathkeeperKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Represents Sora's connection to light").formatted(Formatting.GRAY));
