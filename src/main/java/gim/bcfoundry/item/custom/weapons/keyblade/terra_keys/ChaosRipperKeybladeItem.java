...
public class ChaosRipperKeybladeItem extends SwordItem {
    public ChaosRipperKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Upgraded representation of Terra's darkness").formatted(Formatting.GRAY));
