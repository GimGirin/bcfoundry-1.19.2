...
public class ShootingStarKeybladeItem extends SwordItem {
    public ShootingStarKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Magic centric keyblade from KHIII").formatted(Formatting.GRAY));
