package gim.bcfoundry.item.custom.weapons.keyblade.ventus_keys;
...
public class LostMemoryKeybladeItem extends SwordItem {
    public LostMemoryKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Upgraded version of Ventus' original keyblade").formatted(Formatting.GRAY));
