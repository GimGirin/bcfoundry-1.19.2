...
public class FenrirKeybladeItem extends SwordItem {
    public FenrirKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Reference to Cloud from Final Fantasy").formatted(Formatting.GRAY));
