...
public class WaywardWindKeybladeItem extends SwordItem {
    public WaywardWindKeybladeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if ((Screen.hasShiftDown())) {
            ...
            tooltip.add(Text.literal("Ventus' original keyblade").formatted(Formatting.GRAY));
